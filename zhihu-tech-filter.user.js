...
(function () {
  ...
  const DEFAULT_CONFIG = {
    ...
    nonTechKeywords: [
      '最美', '前任', '前妻', '初恋', '白月光', '朱砂痣', '暗恋', '心动', '表白', '失恋',
      '暧昧', 'crush', '备胎', '渣男', '渣女', '绿茶', '暖男', '直男', '舔狗', '海王',
      '海后', '脱单', '相亲', '约会', '情书', '桃花', '缘分', '意难平', '复合', '挽回',
      '单身', '择偶', '异地恋', '网恋', '奔现', '见家长', '求婚', '订婚', '退婚', '劈腿',
      '出轨', '小三', '插足', '冷暴力', '分手', '绝交', '拉黑', '情感', '爱情', '恋爱',
      '治愈', '温暖', '扎心', '共鸣',
      '怀孕', '生理性喜欢', '避孕', '堕胎', '性教育', '性生活', '性健康', '月经', '妇科', '产检',
      '月子', '哺乳', '备孕', '不孕', '试管婴儿', '避孕套', '安全期', '排卵', '受孕', '流产',
      '引产', '产后', '两性', '性取向', '同性恋', '双性恋', '性冷淡', '性骚扰', '初夜', '一夜情',
      '约炮', '炮友', '开房', '情趣',
      '育儿', '生子', '鸡娃', '带娃', '婆媳', '岳母', '夫妻', '结婚', '离婚', '彩礼',
      '嫁妆', '婚房', '办婚礼', '二胎', '三胎', '学区房', '辅导班', '兴趣班', '早教', '幼升小',
      '小升初', '坐月子', '满月酒', '百日宴', '亲子', '家长会', '陪写作业', '辅导作业', '奶爸', '宝妈',
      '全职妈妈', '丧偶式育儿', '隔代抚养', '留守儿童', '婚姻', '老婆', '老公', '媳妇', '剩女', '逼婚',
      '北京', '上海', '天津', '重庆', '广州', '武汉', '成都', '杭州', '南京', '西安',
      '沈阳', '长春', '哈尔滨', '济南', '太原', '郑州', '合肥', '南昌', '福州', '长沙',
      '贵阳', '昆明', '南宁', '拉萨', '乌鲁木齐', '银川', '西宁', '呼和浩特', '海口', '石家庄',
      '香港', '澳门', '台北', '台湾', '深圳', '珠海', '三亚', '丽江', '桂林', '厦门',
      '青岛', '大连', '苏州', '佛山', '东莞', '无锡', '宁波', '温州', '泉州', '烟台',
      '威海', '北海', '张家界', '九寨沟', '黄山', '泰山', '华山', '峨眉山', '普陀山', '庐山',
      '武夷山', '长白山', '呼伦贝尔', '香格里拉', '西双版纳', '敦煌', '平遥', '乌镇', '周庄', '同里',
      '南浔', '西塘', '阳朔', '稻城', '林芝', '青海湖', '茶卡盐湖', '喀纳斯', '伊犁', '阿勒泰',
      '游记', '民宿', '打卡', '自由行', '跟团', '出境游',
      ...
      '历史', '哲学', '文学', '艺术', '诗歌', '散文', '杂文', '随笔', '书评', '读书', '名著',
      '朝代', '皇帝', '古代', '近代', '抗战', '民国',
      '心理', '抑郁', '焦虑', '心理咨询', '原生家庭',
      '教育', '高考', '考研', '留学', '雅思', '托福', '四六级',
      '社会', '热点', '事件', '新闻', '评论', '舆论',
